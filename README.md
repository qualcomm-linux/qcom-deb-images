...
- `target_boards`: comma-separated list of board names to build (default:
  `all`). Accepted values are the board names defined in
  `debos-recipes/flash-boards.yaml`, e.g. `qcs615-ride`,
...
platforms) live in `debos-recipes/flash-boards.yaml`. Adding a board (or
